...
// ── Wheel patches (renderer chunk). All or nothing: partial patching would break the page ──
...
try {
  ...
  for (const rel of listFiles(original, "app/_next/static/chunks").filter((f) => f.endsWith(".js"))) {
    ...
    if (!code.includes("Math.ceil(22/") || !code.includes('centeredSlides:!0,loop:!0')) continue;
